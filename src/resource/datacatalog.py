...
datacatalog_ns = Namespace(
    "datacatalog", description="Datacatalog Proposals Manager"
)
...
payload_add_benefit = datacatalog_ns.model(
    ...
    {
        "name": fields.String(
            required=True, example="Por morte do trabalhador rural"
        ),
    },
)
...
class ListLoanOperationResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return DataCatalogLoanOperationCore(
                user_id=user_id
            ).add_loan_operation(data=request.get_json())
    ...
    def get(self):
        ...
        try:
            ...
            return DataCatalogLoanOperationCore(
                user_id=user_id
            ).list_loan_operation(data=request.args.to_dict())
        except Exception as e:
            return Response().response(
                status_code=500,
                error=True,
...
class ManageBenefitOperation(Resource):
    ...
    def delete(self, id):
        ...
        try:
            ...
            return DataCatalogBenefitCore(user_id=user_id).delete_benefit(
                id=id
            )
        except Exception as e:
            return Response().response(
...
class ListBenefitOperation(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return DataCatalogBenefitCore(user_id=user_id).add_benefit(
    ...
    def get(self):
        ...
        try:
            ...
            return DataCatalogBenefitCore(user_id=user_id).list_benefit(
...
class ListBankOperation(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return DataCatalogBankCore(user_id=user_id).add_bank(
                data=request.get_json()
            )
    ...
    def get(self):
        ...
        try:
            ...
            return DataCatalogBankCore(user_id=user_id).list_bank(
                data=request.args.to_dict()
            )
        except Exception as e:
            return Response().response(
