...
pagination_arguments_customer = (
    FactoryPayloadsBankers.pagination_arguments_parser()
)
...
paylaod_add_financialagreements = (
    FactoryPayloadsFinancialAgreements.paylaod_add_financialagreements(
        bankers_ns
    )
)
paylaod_edit_financialagreements = (
    FactoryPayloadsFinancialAgreements.paylaod_edit_financialagreements(
        bankers_ns
    )
)
...
class BankerResourceRegister(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return BankersCore(user_id=user_id).add_banker(
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return BankersCore(user_id=user_id).list_bankers(
...
class BankerResourceFilterById(Resource):
    ...
    def put(self, id):
        ...
        try:
            ...
            return BankersCore(user_id=user_id).update_banker(
...
class FinancialAgreeementsResource(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return FinancialAgreementsCore(
                user_id=user_id
            ).add_financial_agreements(data=request.get_json())
        except Exception as e:
            return Response().response(
                status_code=400,
                error=True,
...
class FinancialAgreementsResourceFilterById(Resource):
    ...
    def put(self, id):
        ...
        try:
            ...
            return FinancialAgreementsCore(
                user_id=user_id
            ).update_financial_agreements(id=id, data=request.get_json())
        except Exception as e:
            return Response().response(
                status_code=400,
                error=True,
    ...
    def delete(self, id):
        ...
        try:
            ...
            return FinancialAgreementsCore(
                user_id=user_id
            ).delete_financial_agreements(id=id)
        except Exception as e:
            return Response().response(
                status_code=400,
                error=True,
