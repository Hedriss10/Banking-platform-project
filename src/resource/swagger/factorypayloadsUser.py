...
class PaylaodFactoryUser:
    ...
    def add_user_payload(api):
        return api.model(
            "AddUsser",
            {
                "username": fields.String(required=False, max_length=150, example="David"),
                "lastname": fields.String(required=False, max_length=150, example="Back"),
                "email": fields.String(required=False, max_length=50, example="usersbs@teste.com"),
                "cpf": fields.String(required=True, max_length=25, example=""),
                "password": fields.String(required=False, max_length=250, example="********"),
    ...
    def edit_user_payload(api):
        return api.model(
            "EditUser",
            {
                ...
                "lastname": fields.String(required=False, max_length=150, example="Back"),
                "email": fields.String(required=False, max_length=50, example="usersbs@teste.com"),
                "cpf": fields.String(required=False, max_length=25, example=""),
                "password": fields.String(required=False, max_length=250, example="********"),
                "typecontract": fields.String(required=False, max_length=50, example="Funcionario"),
                "role": fields.String(required=False, max_length=50, example="Administrador"),
                ...
                "is_first_acess": fields.Boolean(required=False, example=False),
                "matricula": fields.String(required=False, example="40028922"),
                "numero_pis": fields.String(required=False, example="40024-32313-3"),
                "empresa": fields.String(required=False, example="BSC4"),
                "situacao_cadastro": fields.String(required=False, example="ativo"),
                "carga_horaria_semanal": fields.Integer(required=False, example=44),
            }
        )
