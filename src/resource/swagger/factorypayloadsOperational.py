        ...
        return api.model(
            "AddTimePoint",
            {
                ...
                "data": fields.DateTime(
                    required=True, example="2024-12-12T09:00:00"
                ),
                "entrada": fields.DateTime(
                    required=True, example="2024-12-12T08:00:00"
                ),
                "saida": fields.DateTime(
                    required=True, example="2024-12-12T18:00:00"
                ),
                "entrada_almoco": fields.DateTime(
                    required=True, example="2024-12-12T12:00:00"
                ),
                "saida_almoco": fields.DateTime(
                    required=True, example="2024-12-12T13:00:00"
                ),
                "entrada_lanche": fields.DateTime(
                    required=True, example="2024-12-12T15:00:00"
                ),
                "saida_lanche": fields.DateTime(
                    required=True, example="2024-12-12T15:15:00"
                ),
            },
        )
    ...
    def add_justification_for_delay(api):
        return api.model(
            "AddJustificationForDelay",
            {
                ...
                "justificativa": fields.String(
                    required=True,
                    example="Funcinario Thon chegou atrasado, verificar com o Master!",
                ),
            },
        )
        ...
        return api.model(
            "AddHoliday",
            {
                ...
                "descricao": fields.String(
                    required=True, example="Feriado Estadual"
                ),
            },
        )
    ...
    def add_absence(api):
        return api.model(
            "AddAbsence",
            {
                ...
                "descricao": fields.String(
                    required=True, example="Não respondeu o whatsapp."
                ),
                "justificativa": fields.String(
                    required=True,
                    example="Não apresentou nenhuma justificativa.",
                ),
    ...
    def edit_absence(api):
        return api.model(
            "EditAbasence",
            {
                "descricao": fields.String(
                    required=True,
                    example="Sim ele respondeu o whatsapp, vai está presente mas chegará atrasado.",
                ),
                "justificavel": fields.Boolean(required=True, example=False),
            },
        )
