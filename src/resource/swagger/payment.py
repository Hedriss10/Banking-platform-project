...
class PaymentsFactoryPayloads:
    ...
    def payload_add_payments(api):
        return api.model(
            "ProcessingPayment",
            {
                ...
                "proposal_id": fields.List(
                    fields.Integer, required=True, example=[1, 2, 3]
                ),
                "user_id": fields.List(
    ...
    def pagination_args_parse():
        ...
        pagination_arguments_payment.add_argument(
            "current_page",
            help="Current Page",
            default=1,
            type=int,
    ...
    def payload_add_service_provided(api):
        return api.model(
            "ProcessingPayment",
            {
                ...
                "valor_operacao": fields.List(
                    fields.Float, required=False, example=[100.00, 200.00]
                ),
            },
        )
