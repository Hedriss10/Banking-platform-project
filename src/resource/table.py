...
paylaod_delete_ids = (
    FactoryPayloadsTablesFinance.payload_delete_tables_finance(tables_ns)
)
...
class TablesFinanceImportResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return TablesCore(user_id=user_id).add_tables_import(
                data={
                    "financialagreements_id": financialagreements_id,
...
class TablesFinanceResource(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return TablesCore(user_id=user_id).add_table(
...
class TablesFinanceResourceById(Resource):
    ...
    def get(self, id: int):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return TablesCore(user_id=user_id).list_board_table(
                data=request.args.to_dict(), financial_agreements_id=id
            )
        except Exception as e:
            return Response().response(
                status_code=400,
    ...
    def delete(self, id: int):
        ...
        try:
            ...
            return TablesCore(user_id=user_id).delete_tables_ids(
...
class RanksTableFinancial(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return TablesCore(user_id=user_id).rank_comission(
            ...
            return Response().response(
                ...
                message_id="something_went_wrong",
                exception=str(e),
                traceback=traceback.format_exc(exit),
            )
