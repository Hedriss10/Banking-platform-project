...
# payloads
pagination_arguments_customer = PayloadFactoryHourspoint.pagination_arguments_parser()
payload_add_timepoint = PayloadFactoryHourspoint.add_time_point(hourspoint_ns)
payload_add_justification_for_delay = PayloadFactoryHourspoint.add_justification_for_delay(hourspoint_ns)
...
class TimePointResourc(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return HourspointCore(user_id=user_id).add_time_point(data=request.get_json())
...
class TimePointResourceID(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).add_justification_for_delay(data=request.get_json())
...
class HolidayManagerResource(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).add_holiday(data=request.get_json())
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_holiday(data=request.args.to_dict())
...
class AbsenceManager(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).add_absence(data=request.get_json())
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_absence_resource(data=request.args.to_dict())
...
class AbsenceManagerId(Resource):
    ...
    def put(self, id: int):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).edit_absence(id=id, data=request.get_json())
...
class VacationManager(Resource):
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).add_vacation(data=request.get_json())
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_vocation_apply(data=request.args.to_dict())
...
class VacationManagerId(Resource):
    ...
    def put(self, id: int):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).edit_vacation(id=id, data=request.get_json())
...
class ListDayOffsManagerResource(Resource):
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_day_offs(data=request.args.to_dict())
...
class ListWorksHoursOrvetime(Resource):
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_works_hours_overtime(data=request.args.to_dict())
...
class ListWorksHoursOrvetimeDelay(Resource):
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_works_delay(data=request.args.to_dict())
...
class ListRankingUserDelayedWorksEmployess(Resource):
    ...
    def get(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return HourspointCore(user_id=user_id).list_ranking_user_delayed_works_employess(data=request.args.to_dict())
