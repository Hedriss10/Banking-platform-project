...
paylaod_proposal_add = proposal_ns.model(
    "AddProposal",
    {
        ...
        "cidade_naturalidade": fields.String(required=False, example="state_city"),
        ...
        "complemento_endereco": fields.String(required=False, example="Apto 45"),
        ...
        "telefone_residencial": fields.String(required=False, example="(61) 3333-3333"),
        "telefone_comercial": fields.String(required=False, example="(61) 4444-4444"),
...
payload_parser.add_argument('extrato_consignacoes', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('contracheque', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('rg_cnh_completo', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('rg_verso', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('rg_frente', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('comprovante_residencia', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('selfie', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
payload_parser.add_argument('detalhamento_inss', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
...
class ListProposalResource(Resource):
    def __init__(self, *args, **kwargs):
        ...
        self.payload_parser.add_argument('extrato_consignacoes', type=FileStorage, required=False, help='Upload an image (PNG or JPEG)', location='files')
