...
class Proposal(db.Model, UserMixin):
    ...
    state_uf_city = db.Column(db.String(10), nullable=True)
    value_salary = db.Column(db.String(30), nullable=True)
    value_salaray_liquid = db.Column(db.String(30), nullable=True)
    ...
    contracheque = db.Column(db.LargeBinary, nullable=True)
    extrato_consignacoes = db.Column(db.LargeBinary, nullable=True)
    comprovante_residencia = db.Column(db.LargeBinary, nullable=True)
    selfie = db.Column(db.LargeBinary, nullable=True)
    comprovante_bancario = db.Column(db.LargeBinary, nullable=True)
    detalhamento_inss = db.Column(db.LargeBinary, nullable=True)
    historico_consignacoes_inss = db.Column(db.LargeBinary, nullable=True)
