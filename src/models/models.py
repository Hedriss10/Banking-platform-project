...
class User(db.Model):
    ...
    action_reset_password_text: Mapped[str] = mapped_column(
...
class Employee(db.Model):
    ...
    numero_pis: Mapped[str] = mapped_column(
        db.CHAR(20),
        nullable=False,
        unique=True,
        comment="Número do PIS/PASEP (11 dígitos)",
    )
    ...
    carga_horaria_semanal: Mapped[float] = mapped_column(
        db.Numeric(5, 2), nullable=False, server_default="44.0"
    )
...
class Company(db.Model):
    ...
    cpnj: Mapped[str] = mapped_column(
        db.String(14), nullable=False, unique=True
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
    )
...
class Role(db.Model):
    ...
    name: Mapped[str] = mapped_column(
        db.String(250), unique=True, nullable=True
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
    )
...
class FlagsProcessing(db.Model):
    __tablename__ = "flags_processing_payments"
    __table_args__ = {"schema": "public"}
    ...
    flag_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.flags.id"), nullable=False
    )
    user_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.user.id"), nullable=False
    )
    proposal_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.proposal.id"), nullable=False
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
    )
    ...
    is_payment: Mapped[bool] = mapped_column(
        db.Boolean, nullable=True, server_default="false"
    )
    created_by: Mapped[int] = mapped_column(db.Integer, nullable=True)
...
class FinancialAgreements(db.Model):
    ...
    banker_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.bankers.id"), nullable=False
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
    )
...
class TablesFinance(db.Model):
    ...
    is_status: Mapped[bool] = mapped_column(
        db.Boolean, nullable=True, server_default="false"
    )
    financial_agreements_id: Mapped[int] = mapped_column(
        db.Integer,
        ForeignKey("public.financial_agreements.id"),
        nullable=False,
    )
...
class ObtianReport(db.Model):
    ...
    name_report: Mapped[str] = mapped_column(
        db.String(20), unique=True, nullable=False
    )
    name_customer: Mapped[str] = mapped_column(
...
class Proposal(db.Model):
    ...
    cidade_naturalidade: Mapped[str] = mapped_column(
    ...
    complemento_endereco: Mapped[str] = mapped_column(
        db.String(100), nullable=True
    )
    cidade: Mapped[str] = mapped_column(db.String(100), nullable=True)
    valor_salario: Mapped[decimal.Decimal] = mapped_column(
        Numeric(10, 2), nullable=True
    )
    salario_liquido: Mapped[decimal.Decimal] = mapped_column(
        Numeric(10, 2), nullable=True
    )
    telefone: Mapped[str] = mapped_column(db.String(100), nullable=True)
    telefone_residencial: Mapped[str] = mapped_column(
        db.String(100), nullable=True
    )
    telefone_comercial: Mapped[str] = mapped_column(
        db.String(100), nullable=True
    )
...
class ProposalBenenift(db.Model):
    ...
    benefit_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.benefit.id"), nullable=False
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
    )
...
class ProposalLoan(db.Model):
    ...
    loan_operation_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.loan_operation.id"), nullable=False
    )
    ...
    data_dispacho: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False
    )
    margem: Mapped[decimal.Decimal] = mapped_column(
    ...
    valor_operacao: Mapped[float] = mapped_column(
    ...
    tables_finance_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.tables_finance.id"), nullable=False
    )
...
class ProposalStatus(db.Model):
    ...
    aguardando_digitacao: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    pendente_digitacao: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    contrato_em_digitacao: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    aceite_feito_analise_banco: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    contrato_pendente_banco: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    aguardando_pagamento: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    contrato_pago: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, default=False
    )
    contrato_reprovado: Mapped[bool] = mapped_column(
        db.Boolean, nullable=False, server_default="false"
    )
    created_at: Mapped[datetime] = mapped_column(
        db.DateTime, nullable=False, server_default=func.now()
...
class ProposalWallet(db.Model):
    ...
    bank: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.bank.id"), nullable=False
    )
...
class PaymentsComission(db.Model):
    ...
    value_operation: Mapped[int] = mapped_column(
        Numeric(10, 2), nullable=False
    )
    user_id: Mapped[int] = mapped_column(
        db.Integer, ForeignKey("public.user.id"), nullable=False
    ...
    deleted_by: Mapped[int] = mapped_column(db.Integer, nullable=True)
    deleted_at: Mapped[datetime] = mapped_column(db.DateTime, nullable=True)
    is_valided: Mapped[bool] = mapped_column(
        db.Boolean, nullable=True, server_default="false"
    )
    is_deleted: Mapped[bool] = mapped_column(
        db.Boolean, nullable=True, server_default="false"
