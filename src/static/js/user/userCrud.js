class usersManager {
    constructor() {
        this.urls = '/user';
        this.importForm = document.getElementById('importUser');
    }

    async addUser(document = this.importForm) {
        document.addEventListener('submit', async (e) => {
            ...
            const formData ={
                ...
                cargo_horario: document.getElementById('cargo_horario').value,
            }
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    alert('Erro ao adicionar o usuário: ' + response.statusText);
                }
            } catch (error) {
                console.error('Error:', error);
                alert('Erro ao adicionar o usuário: ' + error);
            }
