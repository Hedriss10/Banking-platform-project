    ...
    function fetchProposals(searchTerm = '') {
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                emptyRow.innerHTML = `
                    <td colspan="9" class="text-center">Nenhuma proposta encontrada</td>  <!-- Ajuste para colspan correto -->
                `;
            ...
            data.forEach((p) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        ${p.active ? '<span class="badge bg-success">Contrato Disponivel</span>' : ''}
